...
{
	Creature<Terrain, CreatureType>* hunter = gameData.GetHunter();
	RoomCell<Terrain, CreatureType>* cell = hunter->GetRoomCell();
	...
	RoomCell<Terrain, CreatureType>* nextCell = gameData.GetRoom().GetCell(nextColumn, nextRow);
